# +
""" BASF2 tutorial from https://software.belle2.org/sphinx/release-05-01-13/online_book/basf2/first_steering_file.html  """
...
filedirectory = "/nfs/dust/belle2/user/b2soft/1111540100/"
ma.inputMdstList(
...
#### my try
ma.applyCuts("B0", '[isSignal == 1]', path=main)

ma.variablesToNtuple(
    "B0",
    variables=['Mbc', 'isSignal'],
    filename="Mbc_isSignal_cut.root",
    treename="tree",
    path=main,
)
